    ...
    withComponents =
      ...
      components: let
        ...
        components_string =
          ...
          then
            if components_all || components_default || components == "list"
            then components
            else throw "Invalid string for Intel oneAPI components specification. Expected 'all', 'default' or 'list', but got \"${components}\"."
          ...
          else throw "Invalid type for oneAPI components specification. Expected a string ('all', 'default' or 'list') or a list of component names, but got a ${lib.typeOf components}.";
        components_used = let
